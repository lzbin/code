...
function log(msg,attr){
    var logBox = document.getElementById('logBox');
    var innerMsg = logBox.innerHTML;
    logBox.innerHTML = innerMsg + '<br/>' + msg ;
}
    ...
    JED.fn = JED.prototype = {
        ...
        css:function(name, value) {
            ...
            if (typeof name == "string" && typeof value == "string") {
                ...
                var ele = this[0], JeS = function() {
                    ...
                    return function(el, style){
                        style.indexOf('-')>-1 && (style = style.replace(/-(\\w)/g,function(m,a){return a.toUpperCase()}));//change margin-left to marginLeft
            ...
            if (value === undefined && typeof name === "string") {
                return this[0].currentStyle? this[0].currentStyle[name]
                    : window.getComputedStyle(this[0], null)[name];
            }

            if (typeof name === "string" && (value || value === 0)) {
                value = value + ((Number(value) || value == 0)? "px": "");
                name == "float" && (name = this[0].style.cssFloat !== undefined? "cssFloat": "styleFloat");
