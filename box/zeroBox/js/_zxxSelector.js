(function(window, undefined) {
    var $Z = function(selector, context) {
        //返回一个新的 _zxx 对象
    ...
    _zxx.prototype = {
        ...
        init: function(selector, context) {
            if (!selector) return [];  //selector为false，返回空数组
            if (selector.nodeType === 1) {      //selector为标签对象
                this.context = [selector];
            } else if (selector instanceof Array) {
                this.context = selector;
            } else if (typeof selector == "object" && selector.hasOwnProperty("context") && selector.context instanceof Array) { //selector 已经是一个_zxx对象
                this.context = selector.context;
            } else {
                this.context = mini(selector, context);//通过mini方法返回 dom数组对象
            }
    ...
    $Z.fn = _zxx.prototype.init.prototype = _zxx.prototype;
