(function(){
	var d=document,
		...
		ids=null,
		oInput=null;
	d.write('<div id="sangcalender" onselectstart="return false" style="-moz-user-select:none">')
	d.write('<table width="100%" cellspacing="0" cellpadding="0">'+
			'<tr>' +
				'<td>' +
					'<table cellspacing="0" bgcolor="#F0F0F0" width="100%" cellspacing="0" cellpadding="0">'+
			 			'<tr>' +
							'<td width="20" height="25" align="center" id="yearL" title="上一年">&lt;&lt;</td>'+
			 				'<td width="12" align="center" id="monthL" title="上一月">&lt;</td><td align="center">'+
			 					'<span id="y" title="点击选择年份"></span>年<span id="m" title="点击选择月份"></span>月' +
							'</td>'+
			...
			'<tr>' +
				'<td>' +
					'<table width="100%" cellspacing="0" cellpadding="0">'+
						'<tr bgcolor="#F0F0F0" height="18"><td>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td>六</td></tr>' +
					'</table>' +
				'</td>' +
			'</tr>'+
				...
				'<td>' +
					'<table bgcolor="#eeeeee" width="100%" cellspacing="0" cellpadding="0">'+
						'<tr>' +
							...
							'<td align="center" id="minR" title="分增加">&gt;</td><td align="center" id="hoursR" title="时增加">&gt;&gt;</td>' +
						'</tr>'+
					'</table>' +
				'</td>' +
			'</tr>' +
	...
	function addEventForSelect(type){
		function changeInner(){console.log(ids[type]);
		...
		var oSelect=gids.call(d,['calenderSelect'])['calenderSelect'];
		oSelect.focus();
	...
	function each(handler){
		...
		for(var i=0,len=this.length;i<len;i++){
			o=typeof this[i]=="string"?d.getElementById(this[i]):this[i];
			handler(o,i);
		}
	}
	...
	addEvent(ff,"blur",function(e){hide()})
})();
